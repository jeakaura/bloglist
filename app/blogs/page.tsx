      ...
      <div className="mb-5">
        <div className="w-full max-w-full min-w-[200px]">
          <div className="relative">
            <form>
              <input data-testid="filter-input" className="w-full bg-transparent placeholder:text-stone-500 text-sm rounded-3xl border border-stone-500 rounded pl-3 pr-16 py-2"type="text" name="filter" placeholder="filter blogs..." />
              <button data-testid="search-button" className="cursor-pointer absolute right-2 top-2 rounded-xl border border-blue-600 py-0 px-2 text-center text-sm text-blue-600 transition-all hover:bg-blue-600 hover:text-white" type="submit">filter</button>
            </form>
          </div>
        </div>
      </div>
